...
/*  while ( 1 ) {
     ...
     motorSet (1, 50 *(joystickGetDigital(1, 6, JOY_UP)));
     motorSet (6, 50 *(joystickGetDigital(1, 6, JOY_DOWN)));

     motorSet (2, 100 *(joystickGetDigital(1, 7, JOY_UP)));
     motorSet (3, 100 *(joystickGetDigital(1, 7, JOY_DOWN)));
     motorSet (4, 100 *(joystickGetDigital(1, 7, JOY_LEFT)));
     motorSet (5, 100 *(joystickGetDigital(1, 7, JOY_RIGHT)));

     motorSet (10, 100 *(joystickGetDigital(1, 8, JOY_UP)));
     motorSet (7, 100 *(joystickGetDigital(1, 8, JOY_DOWN)));
     motorSet (8, 100 *(joystickGetDigital(1, 8, JOY_LEFT)));
     motorSet (9, 100 *(joystickGetDigital(1, 8, JOY_RIGHT)));
...
void taskLoad( void * parameter ) {
    while ( true ) {
      ...
      if  (digitalRead(LIMIT_SWITCH) == HIGH)   {
        setCat(120* joystickGetDigital(1, 6, JOY_DOWN) - 50 * joystickGetDigital(1, 8, JOY_DOWN));


      }
      //if catapult is not touching the switch    nn
...
//  issueMotors(127,5000);
  ...
  while ( true) {
		...
		double factor =  joystickGetAnalog( JOY_MASTER, AXIS_LEFT_V )  / 127.0 ;
